...
import AnkanImage from "../../assets/participants-images/profile-pic.jpeg";
    ...
    return (
        <div className="w-full lg:p-6 md:p-5 sm:p-4 p-3">
            ...
            <div className="flex w-full flex-wrap items-center justify-center md:my-5">
                ...
                <ContributorCard imageUri={AnkanImage.src} name="Aditya" roles={["Frontend Developer", "UI/UX Designer"]} github="https://github.com/Ankan002" revealTime={0.1} />
            </div>
        </div>
    );
};
